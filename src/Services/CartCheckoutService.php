...
namespace Centrex\Cart\Services;
...
class CartCheckoutService
{
    ...
    {
        $cartInstance = $this->cart->instance(
        ...
        $this->attachCheckoutMetadata($saleOrder, [
            'channel'       => $channel,
            'cart_instance' => $cartInstance->getInstanceName(),
            'cart_lines'    => $cartInstance->lines(),
            'cart_count'    => $cartInstance->count(),
            'cart_subtotal' => $cartInstance->subtotal(),
            'cart_tax'      => $cartInstance->tax(),
            'cart_total'    => $cartInstance->total(),
